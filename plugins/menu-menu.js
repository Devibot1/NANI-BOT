...
⊜ *Tokens ➟* ${joincount} 🪙
${readMore}
*╭━〔 INFORMACIÓN DE THENANIBOT 〕⬣*
┃💫➺ ${usedPrefix}creador ➺ naniprecios ➺ naniinfo
┃💫➺ ${usedPrefix}creador ➺ pachon ventas
┃💫➺ ${usedPrefix}numero de mi creador ➺ wa.me/525634990524
┃💫➺ ${usedPrefix}para comprar el bot ➺ wa.me/525634990524
┃💫➺ ${usedPrefix}para ver precios del bot ➺ precios
┃💫➺ ${usedPrefix}para ver información del bot ➺ naniinfo
...
┃ *Mejora tú Grupo con TheNaniBot!!*
┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
